...
namespace SuperWebSocket
{
    ...
    public class WebSocketSession : WebSocketSession<WebSocketSession>
    {
        ...
        public void Offline()
        {
            ...
            {
                cmd_id = MainProtocol.Login,
            };

            socketData.SetData(new { userId = UserId });
        ...
        where TWebSocketSession : WebSocketSession<TWebSocketSession>, new()
    {
        ...
        public void Send(SocketData socketData)
        {
            ...
            var json = JsonConvert.SerializeObject(socketData, Formatting.Indented, jsonSetting);
            ProtocolProcessor.TrySendMessage(this, json);
        }
